...
pub enum ErrorKind {
    ...
    /// An error occured because the repository is invalid in some way,
    InvalidRepository(ErrorContext),
}

// TODO: Both Display and Debug should handle the cases where error is none and displaya different message
